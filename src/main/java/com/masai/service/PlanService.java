...
public interface PlanService {
	...
	List<Double> getPremiumAmount(String planName) throws SomeThingWentWrongException, NoRecordFoundException;
	List<Double> getPremiumAmount(String planName, LocalDate nextToExpDate) throws SomeThingWentWrongException, NoRecordFoundException;
}
